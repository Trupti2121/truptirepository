...
public class ScrollTillParticularWebElement {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement shoes = driver.findElement(By.xpath("//img[@class='w-full bg-puma-black-800 aspect-1-1']/ancestor::div[@class='relative w-full flex flex-col gap-2']/descendant::h3[contains(@class,'w-full')]/span[text()='PUMA Black-For All Time Red']"));
